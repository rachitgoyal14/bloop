...
const features = [
  ...
  },
  {
    ...
    icon: Video,
    videoPlaceholder: "bg-gradient-to-br from-gray-900 to-bloop-blue"
  },
  {
    id: 2,
    title: "Quiz Arena",
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-4 text-white">
            Our <span className="text-bloop-lime">Core Engine.</span>
          </h2>
            ...
            {features.map((feature, index) => {
                 ...
                 return (
                   <motion.div
                     ...
                     style={{
                         boxShadow: isHovered 
                            ? '0 25px 50px -12px rgba(199, 246, 16, 0.15)' 
                         ...
                         <div className={`absolute inset-0 flex flex-col items-center justify-center bg-black transition-all duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'}`}>
                             ...
                             <div className="w-full h-full relative flex items-center justify-center bg-gray-900">
                                 ...
                                 <div className="flex flex-col items-center gap-2 z-10">
                                     <Play className="text-bloop-lime fill-bloop-lime animate-pulse" size={32} />
                                     <span className="text-[8px] font-mono text-bloop-lime uppercase tracking-widest">Preview</span>
                                 </div>
                             </div>
