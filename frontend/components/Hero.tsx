...
const Eye: React.FC = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="w-6 h-6 md:w-10 md:h-10 rounded-full bg-bloop-lime"
...
const Hero: React.FC = () => {
  ...
  const playBloop = () => {
    ...
    // Create a "bloop" sound using a sine wave with a frequency drop
    osc.type = 'sine';
    ...
    >
      ...
      >
        ...
        <motion.p 
            ...
            className="mt-8 text-lg md:text-2xl font-bold max-w-xl text-center px-4 text-bloop-lime"
        >
        ...
        >
            <button 
                onClick={playBloop}
                className="bg-white text-black px-10 py-4 rounded-full font-bold text-xl hover:bg-bloop-lime transition-all flex items-center gap-2 group shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-10px_rgba(199,246,16,0.4)] active:scale-95"
            >
                Bloop Now
