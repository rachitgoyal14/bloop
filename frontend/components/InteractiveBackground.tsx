...
const InteractiveBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none select-none bg-bloop-dark">
        {/* Static Grid */}
        ...
        <motion.div 
            style={{ x: x1, y: y1 }}
            className="absolute top-0 left-0 w-[800px] h-[800px] -ml-[400px] -mt-[400px] bg-bloop-lime rounded-full opacity-[0.15] blur-[120px] mix-blend-screen will-change-transform"
        />
        
        {/* Secondary Ambient Blob - Lags behind for depth */}
        <motion.div 
            style={{ x: x2, y: y2 }}
            className="absolute top-0 left-0 w-[1000px] h-[1000px] -ml-[500px] -mt-[500px] bg-bloop-lime rounded-full opacity-[0.05] blur-[150px] mix-blend-screen will-change-transform"
        />

        {/* Static Ambient Light - Bottom Right */}
        <div className="absolute bottom-[-20%] right-[-10%] w-[60vw] h-[60vw] bg-bloop-lime rounded-full opacity-[0.08] blur-[150px]" />
    </div>
  );
};
