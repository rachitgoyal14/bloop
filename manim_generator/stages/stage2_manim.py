...
from manim_generator.utils.json_safe import extract_json
from manim_generator.utils.timestamps_extractor import extract_timestamps
import re
...
def generate_manim(scenes):
    ...
    prompt_path = f"manim_generator/prompts/{scenes_category.lower()}_manim.txt"
